  ...
  <div class="slide story" id="intro" data-slide="1" style="height: 680px;">
    ...
    <div class="container" style="background-color: rgba(50,50,50,0); ">
        <div class="col-md-4 col-md-offset-4" style="background-color: rgba(50,50,50,0.5); width: 400px; ">
          ...
          <form style="font-size: 20px; padding-top: 50px; padding-left: 10px;padding-bottom: 50px;padding-right: 10px;" class="form-signin" action="<?php echo base_url().'Admin/input_aksi_petugas/'?>" method="post">
             <?php endif;?>
            ...
            <td><b>Username </b></td>
            <td> 
            <input style="height: 50px; font-size: 25px; background-color:rgba(0,0,100,0.2); color: white" type="text" id="id" name="username" class="form-control"required ></td></tr>

            <tr style="">
            <td><b>Password </b></td>
            <td> 
            <input style="height: 50px; font-size: 25px; background-color:rgba(0,0,100,0.2); color: white" type="text" id="id" name="password" class="form-control"required ></td></tr>

            <tr>
            <td><b>Nama Lengkap </b></td>
            <td> 
            <input style="height: 50px; font-size: 25px; background-color:rgba(0,0,100,0.2); color: white" type="text" id="id" name="nama_lengkap" class="form-control"  required ></td></tr>
...
value="petugas">PETUGAS</td></tr>
            ...
            <td><b>Jabatan </b></td>
            <td> 
            <input style="height: 50px; font-size: 25px; background-color:rgba(0,0,100,0.2); color: white" type="text" id="id" name="jabatan" class="form-control" required ></td></tr>
