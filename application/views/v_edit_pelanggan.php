  ...
  <?php foreach ($pelanggan as $data) 
    ...
    <div class="container" style="background-color: rgba(50,50,50,0); ">
        <div class="col-md-4 col-md-offset-4" style="background-color: rgba(50,50,50,0.5); width: 400px; ">
          ...
          <form style="font-size: 20px; padding-top: 50px; padding-left: 10px;padding-bottom: 50px;padding-right: 10px;" class="form-signin" action="<?php echo base_url().'Admin/update_pelanggan/'.$data->ID ?>" method="post">
             <?php endif;?>
           
            <?php if($this->session->userdata('akses')=='petugas'):?>
                        <form class="form-signin" action="<?php echo base_url().'Petugas/update_pelanggan/'.$data->ID ?>" method="post">
             <?php endif;?>
